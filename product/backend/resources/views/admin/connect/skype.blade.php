...
@section('title', 'Configure Skype - Aprilo AI')

@section('content')
    <div class="header">
        <div>
            <div class="eyebrow">HR Operations</div>
            <h1>Configure Skype Integration</h1>
            <p class="help">Route escalation tickets and employee inquiries directly through Skype. This requires registering your Skype Bot on the Microsoft Bot Framework.</p>
        </div>
    </div>

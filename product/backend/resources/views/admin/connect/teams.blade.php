...
@section('title', 'Configure Microsoft Teams - Aprilo AI')

@section('content')
    <div class="header">
        <div>
            <div class="eyebrow">HR Operations</div>
            <h1>Configure Microsoft Teams Integration</h1>
            <p class="help">Route employee notifications and escalation alerts directly to Microsoft Teams. Choose between incoming webhooks or a direct interactive Microsoft Teams Bot App.</p>
        </div>
    </div>
